        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-sm text-gray-500">12 ani de experiență</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-gray-500">8 ani de experiență</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-gray-500">6 ani de experiență</p>
            </div>
          </div>
        </div>
      </section>
