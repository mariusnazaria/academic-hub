  ...
  const teachers = [
    {
      ...
      subjects: ['Algebră', 'Geometrie', 'Analiză Matematică', 'Probabilități'],
      specializations: [
    ...
    },
    {
      ...
      subjects: ['Integrale definite', 'Integrale nedefinite', 'Geometrie în spațiu', 'Coordonate'],
      specializations: [
    ...
    },
    {
      ...
      experience: '4+ ani experiență',
      education: 'Universitatea de Stat din Moldova, Facultatea de Matematică',
      subjects: ['Combinatorică', 'Permutări', 'Combinații', 'Teste statistice'],
      specializations: [
